...
export const loginLoginAccessTokenQueryKey = (options: Options<LoginLoginAccessTokenData>) =>
...
export const loginRecoverPasswordQueryKey = (options: Options<LoginRecoverPasswordData>) =>
...
export const loginResetPasswordQueryKey = (options: Options<LoginResetPasswordData>) =>
...
export const usersCreateUserQueryKey = (options: Options<UsersCreateUserData>) =>
...
export const usersRegisterUserQueryKey = (options: Options<UsersRegisterUserData>) =>
...
export const utilsTestEmailQueryKey = (options: Options<UtilsTestEmailData>) =>
...
export const itemsCreateItemQueryKey = (options: Options<ItemsCreateItemData>) =>
...
export const privateCreateUserQueryKey = (options: Options<PrivateCreateUserData>) =>
