        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-[hsl(var(--gradient-1))] via-[hsl(var(--gradient-2))] to-[hsl(var(--gradient-3))] opacity-0 group-hover:opacity-100 transition-opacity duration-300 animate-[gradient-shift_2s_linear_infinite]" style={{ backgroundSize: '300% 300%' }} />
            </Button>
          </a>
