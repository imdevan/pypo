...
export const tagsReadTagsQueryKey = (options?: Options<TagsReadTagsData>) => createQueryKey('tagsReadTags', options);

/**
 * Read Tags
 * Retrieve all tags.
 */
export const tagsReadTagsOptions = (options?: Options<TagsReadTagsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await Tags.readTags({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: tagsReadTagsQueryKey(options)
    });
};

export const tagsCreateNewTagQueryKey = (options: Options<TagsCreateNewTagData>) => createQueryKey('tagsCreateNewTag', options);

/**
 * Create New Tag
 * Create new tag.
 */
export const tagsCreateNewTagOptions = (options: Options<TagsCreateNewTagData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await Tags.createNewTag({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: tagsCreateNewTagQueryKey(options)
    });
};
 ...
 * Create new tag.
 */
export const tagsCreateNewTagMutation = (options?: Partial<Options<TagsCreateNewTagData>>): UseMutationOptions<TagsCreateNewTagResponse, AxiosError<TagsCreateNewTagError>, Options<TagsCreateNewTagData>> => {
    const mutationOptions: UseMutationOptions<TagsCreateNewTagResponse, AxiosError<TagsCreateNewTagError>, Options<TagsCreateNewTagData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await Tags.createNewTag({
                ...options,
                ...localOptions,
 ...
 * Delete a tag.
 */
export const tagsDeleteExistingTagMutation = (options?: Partial<Options<TagsDeleteExistingTagData>>): UseMutationOptions<TagsDeleteExistingTagResponse, AxiosError<TagsDeleteExistingTagError>, Options<TagsDeleteExistingTagData>> => {
    const mutationOptions: UseMutationOptions<TagsDeleteExistingTagResponse, AxiosError<TagsDeleteExistingTagError>, Options<TagsDeleteExistingTagData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await Tags.deleteExistingTag({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const tagsReadTagQueryKey = (options: Options<TagsReadTagData>) => createQueryKey('tagsReadTag', options);

/**
 * Read Tag
 * Get tag by ID.
 */
export const tagsReadTagOptions = (options: Options<TagsReadTagData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await Tags.readTag({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: tagsReadTagQueryKey(options)
    });
};
 ...
 * Update a tag.
 */
export const tagsUpdateExistingTagMutation = (options?: Partial<Options<TagsUpdateExistingTagData>>): UseMutationOptions<TagsUpdateExistingTagResponse, AxiosError<TagsUpdateExistingTagError>, Options<TagsUpdateExistingTagData>> => {
    const mutationOptions: UseMutationOptions<TagsUpdateExistingTagResponse, AxiosError<TagsUpdateExistingTagError>, Options<TagsUpdateExistingTagData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await Tags.updateExistingTag({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const tagsReadItemsByTagQueryKey = (options: Options<TagsReadItemsByTagData>) => createQueryKey('tagsReadItemsByTag', options);

/**
 * Read Items By Tag
 * Get all items tagged with a specific tag.
 */
export const tagsReadItemsByTagOptions = (options: Options<TagsReadItemsByTagData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await Tags.readItemsByTag({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: tagsReadItemsByTagQueryKey(options)
    });
};
